...
if ($_GET['aksi'] == "pinjam") {
    ...
    if ($_POST['judulBuku'] == NULL) {
        ...
        if ($cek > 0) {
            ...
            $sql = "INSERT INTO peminjaman(nama_anggota,judul_buku,tanggal_peminjaman,kondisi_buku_saat_dipinjam,tanggal_pengembalian,kondisi_buku_saat_dikembalikan,denda)
