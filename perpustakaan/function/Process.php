...
if ($_GET['aksi'] == "masuk") {
    ...
    $fullname = isset($_POST['funame']) ? $_POST['funame'] : '';
    $username = isset($_POST['uname']) ? addslashes(strtolower($_POST['uname'])) : '';
    $username1 = str_replace(' ', '', $username);
    $password = isset($_POST['passw']) ? $_POST['passw'] : '';
    $kls = isset($_POST['kelas']) ? $_POST['kelas'] : '';
    ...
    $sql = "INSERT INTO user(kode_user,nis,fullname,username,password,kelas,alamat,verif,role,join_date,terakhir_login)
            VALUES('" . $Anggota . "','" . $nis . "','" . $fullname . "','" . $username1 . "','" . $password . "','" . $kelas . "','" . $alamat . "','" . $verif . "','" . $role . "','" . $join_date . "','" . $terakhir_login . "')";
